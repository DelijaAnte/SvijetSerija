...
export default function ActorDetailsPage({ params }) {
  ...
  if (loading) {
    return (
      <div className="p-4 flex flex-col items-center text-center animate-pulse">
        <div className="w-48 h-8 bg-gray-300 rounded mb-4" />
        <div className="w-[300px] h-[400px] bg-gray-300 rounded mb-4" />
        ...
        <div className="w-60 h-6 bg-gray-300 rounded mb-4" />
